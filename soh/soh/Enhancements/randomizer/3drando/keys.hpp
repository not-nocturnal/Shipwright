...
////EVENTS_AND_DROPS
  ...
  THIEVES_HIDEOUT,
  GF_1F_LEFT,
  GF_1F_BEHIND_CRATES_LEFT,
  GF_1F_BEHIND_CRATES_MIDDLE,
  GF_1F_RIGHT,
  GF_2F_LEFT,
  GF_2F_MIDDLE,
  GF_2F_RIGHT,
  ...
  GF_4F_MIDDLE,
  GF_BALCONY,
  TH_1_TORCH_JAIL_1_TURN,
  TH_1_TORCH_JAIL_0_TURNS,
  TH_2_TORCH_JAIL_LOWER,
  TH_2_TORCH_JAIL_UPPER,
  TH_3_TORCH_JAIL,
  TH_4_TORCH_JAIL_1_TURN,
  TH_4_TORCH_JAIL_2_TURNS,
  TH_KITCHEN_HALLWAY_LOWER,
  TH_KITCHEN_HALLWAY_UPPER,
  TH_KITCHEN_LEDGE_NEAR,
  TH_KITCHEN_LEDGE_FAR,
  TH_BREAK_ROOM_LOWER,
  TH_BREAK_ROOM_UPPER,
  GF_OUTSIDE_GATE,
  GF_STORMS_GROTTO,
